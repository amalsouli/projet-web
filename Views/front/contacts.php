						...
						<div class="grid_12">
							<nav class="fleft">
								<ul class="services-menu">
									...
									<li class="m2"><a href="contacts.php"></a></li>
			...
			<div class="header-row"><div class="ic">More Website Templates @ TemplateMonster.com - November 07, 2011!</div>
				<div class="main">
					...
					<div class="container_12">
						<div class="wrapper">
							<div class="grid_12">
								<h4>Reclamation Form</h4>
								<form action="ajouterReclamation.php" method="POST">					
									<fieldset>
										<div class="wrapper">
											<label class="img-indent2"><span class="text-form">nom:</span><input name="nom" type="text" /></label>
											<label class="fleft"><span class="text-form">prenom:</span><input name="prenom" type="text" /></label>
										</div>
																	 
										<div class="wrapper">
										  <div class="text-form">reclamation:</div>
										  <div class="extra-wrap">
											  <label class="message"><input type="text" name="description"  ></label>
											  <div class="buttons">
