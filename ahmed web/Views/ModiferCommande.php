        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="PrixProduit" name="PrixProduit" id="PrixProduit" value="<?php echo $Commande['PrixProduit']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="date" name="date" id="date" value="<?php echo $Commande['date']; ?>">
                    </td>
                </tr>              
                <tr>
                    <td></td>
